...
class Administrator {
    ...
    async processM2GSMessage(socket, content) {
        ...
        if (T <= 10000) {
            ...
            if (tHashComp === tHash){
                ...
                // // const binaryString = Buffer.from(resp, 'base64');
                // // console.log("binarystring:",binaryString);
                // // const uint8Arraynew = new Uint8Array(binaryString);
                // // console.log("uint8array:",uint8Arraynew);
                // // const uint8Array = new Uint8Array(uint8Arraynew);
                ...
                // const uint8Array2 = new Uint8Array(this.resForKey);
    ...
    async processM3UAMessage(socket, content) {
        ...
        console.log("RESP1:",this.response);
        const resp = this.convertNumbersStringToByteArray(this.response);
        console.log("RESP:",resp,"Hii",this.response);
