...
class Client {
    ...
    async processM4UGMessage(socket, content) {
        console.log("Message M4UG starts being processed here");
        ...
        if (T <= 10000) {
            ...
            if (Hash == hashToComp){
                console.log("Authenticity and Integrity check Successfull");
            }
            else{
            ...
            console.log(PI, "updated PI");
            // const uint8Array = new Uint8Array(res);
            // const resp = Buffer.from(uint8Array);
            ...
            // if(authenticityUD === this.xorStrings(this.PI,GS)){
            // console.log("Authenticity check successful");
            // }
            // else{
            // console.log("Authenticity check unsuccessful",authenticityUD," != ",this.xorStrings(PI,GS));
            // }
            ...
            console.log("Message M4UG finishes being processed here");
            console.log("Execution time of authentication:",executionTime,"milliseconds");
        }
        else {
    ...
    async processM2UAMessage(socket, content) {
        console.log("Message M2UA starts being processed here");
        ...
        console.log("Response generated(Ru):",response);
        ...
        console.log("Alpha Computed:",alpha);
        ...
        console.log("Message M2UA finishes being processed here");
    ...
    async processM4UAMessage(socket, content) {
        ...
        console.log("Message M4UA starts being processed here");
        ...
        this.endTime = performance.now();
        const executionTime = this.endTime-this.startTime;
        console.log("Message M4UA finishes being processed here");
        console.log("Execution time of registration:",executionTime,"milliseconds");
        socket.end();
    }

    async processM2UGMessage(socket, content) {
        console.log("Message M2UG startes being processed here");
        ...
        try {
            ...
            if (T <= 10000) {
                ...
                // Computing XOR of Gateway secret and response
