...
class Client {
    ...
    async processM4UGMessage(socket, content) {
        ...
        console.log("encrypted data -> ",content.encryptedData);
        ...
        if (T <= 10000) {
            ...
            let newKey = this.xorStrings(this.bufferTo256BitString(res),hexStr);
       ...
       console.log("j ",j);
        ...
        try {
            ...
            if (T <= 10000) {
              ...
              //  beta1 = this.xorStringWith256BitString(beta1,this.keyForAES);
               // console.log(beta1);
                let betaS = "";
