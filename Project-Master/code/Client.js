    ...
    async initializeClient() {
        ...
        socket.connect(this.PORT, ipAddress, async () => {
            ...
            if (input === '1') {
                ...
                // const UideXOR = this.xorStrings(Nonce.toString(),this.ID);
                // const SNIDXOR = this.xorStrings(Nonce.toString(),this.SNID);
                const M1UG = this.mode + " " + this.PI + " " + Nonce + " " + this.SNID + " " + this.ID;
                const m1ug = {
                    type: 'M1UG',
                    content: M1UG
                };
    ...
    async processM2UGMessage(socket, content) {
        ...
        try {
            ...
            if (T <= 10000) {
                ...
                //     const byte = parseInt(PI.substr(i, 2), 16);
                //     secretBytes1.push(byte);
                // }
                // const beta = betaXOR.map((num, index) => num ^ secretBytes1[index]);
                ...
                if (omega === j) {
                    ...
                    const delta = this.xorStrings(midhash.toString(), gatewaySecret);
                    ...
                    M3UG = Date.now() + " " + delta + " " + m5 + " " + this.PI + " " + tHash + " " + cAddress;
