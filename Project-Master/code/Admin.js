...
class Administrator {
    ...
    async processM2ASMessage(socket, content) {
        ...
        console.log("Keys for sensor :" , keyForAES);
        ...
        // Check if contract has been deployed for the first user
        ...
        if (count === 0) {
            ...
            // // Retrieve gas used and gas price from the transaction details
            // const gasUsed = tx.gasUsed;
            // const gasPrice = tx.gasPrice;

            // // Calculate ethers used
            // const ethersUsed = ethers.utils.formatEther(gasUsed.mul(gasPrice));

            // console.log('Gas used:', gasUsed.toString());
            // console.log('Gas price (wei):', gasPrice.toString());
            // console.log('Ethers used:', ethersUsed);
            // console.log('Contract deployed at address:', contract.address);
            cA = contract.address;
            // await contract.addUnD(this.alpha, t);
            const dataToInsert = {
                cAddress: cA,
            };
        ...
        // const alpha1 = ethers.BigNumber.from(alpha);
        ...
        const Message_3 = this.TH4 + " " + this.CA + " " + PI + " " + GS + " " + keyForAES;
